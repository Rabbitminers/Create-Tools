...
public enum CTArmorMaterial implements ArmorMaterial {
    // Boots -> helmet
    ...
    private CTArmorMaterial(String name, int p_40475_, int[] p_40476_, int p_40477_, SoundEvent soundEvent, float toughness, float p_40480_, Supplier<Ingredient> p_40481_) {
        this.name = name;
    ...
    public String getName() {
        return CreateTools.MODID + ":" + this.name;
    }
