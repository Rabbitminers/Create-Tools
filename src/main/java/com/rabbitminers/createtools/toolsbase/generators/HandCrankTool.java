...
public class HandCrankTool extends DiggerItem {

    int remainingTicks = 0;
    int maxTicks = 1200;

    public HandCrankTool(float p_204108_, float p_204109_, Tier p_204110_, TagKey<Block> p_204111_, Properties p_204112_) {
